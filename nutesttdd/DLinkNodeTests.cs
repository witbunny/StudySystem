...
namespace nutesttdd
{
	...
	{
		DLinkNode node1, node2, node3, node4;
		...
		public void AddTest()
		{
			...
			//尾
			DLinkNode node10 = new DLinkNode();
			...
			//AddBefore
			//首
			DLinkNode node21 = new DLinkNode();
			...
			//中
			DLinkNode node22 = new DLinkNode();
			...
			//尾
			DLinkNode node23 = new DLinkNode();
